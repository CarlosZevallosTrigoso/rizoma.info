...
<span class="txt-pequeno"> Para inscribirse solo es necesario enviar un correo a info@rizoma.pe o mandar un dm a nuestra cuenta de IG (@rizoma.pe)</span>.
...
Por otro lado, el archivo será explorado como dispositivo fundante de las sociedades modernas que integra no solo instituciones y objetos archivados, sino también disposiciones y lógicas culturales que penetran diversas capas de la cotidianidad.

Finalmente, trataremos a la curaduría (o lo curatorial) como un concepto en tensión que, si bien emerge del campo museal, se desborda activamente hacia otras esferas de la vida contemporánea, como son el consumo de contenidos y el diseño de la imagen propia.

Antes de iniciar el curso, cada inscritx recibe un enlace a una carpeta donde encontrará lecturas (principalmente) y otros recursos. Sin embargo, hacer las lecturas no es obligatorio para participar de las clases online. Todo el contenido se despliega principalmente durante las tres horas en que nos conectamos. Cada unx decide su nivel de participación e interacción, pero siempre tratamos de ubicar la discusión hacia el final de cada clase (últimos 30-40 minutos).
